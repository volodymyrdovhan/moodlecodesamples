...
/**
 * Class containing products edit page for intellicart plugin
 *
 * @package    local_intellicart
 * @author     IntelliBoard Inc
 * @copyright  2021 IntelliBoard, Inc
 ...
 */
class coupons_edit implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        return [
            ...
            'page-type' => 'coupons-edit',
            'lms-type'  => util::get_lms_type(),
            'title'     => $this->params['title'],
            'content'   => $output->render_from_template('local_intellicart/edit-page', $this->params)
        ];
    }
}
